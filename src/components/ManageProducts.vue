...
<!-- <template>
  <div class="bg-gray-100 h-screen">
    <div class="flex flex-col items-center w-full">
      <h1 class="mb-4 mt-8 text-slate-700 font-bold text-2xl text-center">Cadastro de Produtos</h1>
      <form
...
<template>
  <div class="bg-gray-100 min-h-screen">
    ...
    <div class="flex justify-center w-full mt-8">
      <div
        class="w-full md:w-3/4 lg:w-1/2 xl:w-1/3 border border-solid border-cyan-800 rounded-md bg-white"
      >
        <table class="w-full">
          <thead class="border-b border-gray-500 w-full">
            <tr>
